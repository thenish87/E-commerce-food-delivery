...
//   if (existingProduct) {
//     alert('Item already in yur cart')
//     return;
//   }
...
//     e.preventDefault(); // when add quantity page not load/refresh
//     quantity++;
...
const showCard = (products) => {
  cardList.innerHTML = ''; // clear old cards
...
const initApp = () => {
  fetch('products.json')
    ...
    .then(data => {
      productList = data;
      console.log(productList);
      showCard(productList); // show all products
    });
};
